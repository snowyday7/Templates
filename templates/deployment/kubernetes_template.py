...
class KubernetesGenerator:
    ...
    def generate_namespace(self, name: str, labels: Optional[Dict[str, str]] = None) -> Dict[str, Any]:
        """生成Namespace配置"""
        namespace = {
            "apiVersion": "v1",
            "kind": "Namespace",
    ...
    def generate_config_map(self, name: str, namespace: str = "default",
    ...
    def generate_secret(self, name: str, namespace: str = "default",
                       data: Optional[Dict[str, str]] = None,
    ...
    def generate_deployment(self, config: DeploymentConfig) -> Dict[str, Any]:
        ...
        for container in config.containers:
            ...
            if container.liveness_probe:
                container_spec["livenessProbe"] = self._build_probe(container.liveness_probe)
            
            if container.readiness_probe:
                container_spec["readinessProbe"] = self._build_probe(container.readiness_probe)
        ...
        deployment = {
            ...
            "spec": {
                ...
                "selector": {
                    "matchLabels": config.selector_labels
                },
    ...
    def generate_complete_app(self, app_name: str, image: str, 
                             namespace: str = "default",
                             replicas: int = 3,
                             port: int = 8000,
                             domain: Optional[str] = None) -> Dict[str, Dict[str, Any]]:
        """生成完整应用的所有配置"""
        configs = {}
    ...
    def save_complete_app(self, app_name: str, image: str,
                         namespace: str = "default",
                         replicas: int = 3,
                         port: int = 8000,
...
def generate_complete_app(app_name: str, image: str, **kwargs) -> Dict[str, Dict[str, Any]]:
    """生成完整应用配置"""
